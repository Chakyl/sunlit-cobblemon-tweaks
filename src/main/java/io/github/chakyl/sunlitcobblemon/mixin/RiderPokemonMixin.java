...
//        pokemonJsonObject.add("Lapras", new PokemonJsonObject.PokemonConfigData(new ArrayList(List.of(MountType.SWIM)), new ArrayList(Arrays.asList(0.0F, 0.0F, 0.0F))));
        ...
        pokemonJsonObject.add("Nidoking", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 1.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Moltres", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 1.9F, 0.0F))), 300, 1.6F));
        pokemonJsonObject.add("Zapdos", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 1.9F, 0.0F))), 300, 1.6F));
        pokemonJsonObject.add("Articuno ", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 1.9F, 0.0F))), 600, 1.2F));
        pokemonJsonObject.add("Altaria", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.FLY)), new ArrayList<>(List.of(0.0F, 0.3F, 0.0F))), 400, 1.0F));
        pokemonJsonObject.add("Luxray", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 1.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Mamoswine", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 5.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Relicanth", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.SWIM)), new ArrayList<>(List.of(0.0F, 1.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Espahtla", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 1.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Dragonite", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 2.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Garchomp", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 2.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Dodrio", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 1.2F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Mudsdale", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 2.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Ursaluna", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 1.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Metagross", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 2.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Corviknight", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 3.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Staraptor", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 1.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Dragapult", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.FLY)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Kilowattrel", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Beedrill", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Nidoqueen", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Salamence", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Arceus", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK, MountType.FLY, MountType.SWIM)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Galvantula", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        pokemonJsonObject.add("Haxorus", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.WALK)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
        ...
        pokemonJsonObject.add("Volcarona", IPokemonConfig.apply(new PokemonJsonObject.PokemonConfigData(new ArrayList<>(List.of(MountType.FLY)), new ArrayList<>(List.of(0.0F, 0.0F, 0.0F))), 0, 1.0F));
